...
public class Print_form extends javax.swing.JFrame {
    ...
    String rec,roll_no,rece,dt,ses1,ses2,c,amount1,gst,sgst,totl;
    
    public Print_form(String r,String roll,String received,String d,String session1,String session2,String course1,String amount,String item,String item1,String item2) throws PrinterException {
        initComponents(); 
        this.rec=r;
        this.roll_no=roll;
        this.rece=received;
        ...
        this.gst=item1; 
        this.gst=item2;
        text1.setText(text1.getText()+"                                         DEPARTMENT OF COMPUTER SCIENCE                        \n");
        text1.setText(text1.getText()+"                                                   AND APPLICATIONS                            \n"); 
        text1.setText(text1.getText()+"                                          PANJAB UNIVERSITY,CHANDIGARH               \n");   
        text1.setText(text1.getText()+"==========================================================================================\n");
        text1.setText(text1.getText()+"Receipt no: "+rec+"\t\t\t\tDate:"+dt);
        text1.setText(text1.getText()+"\nReceived From: "+rece+"\t\t\t GSTIN:27AAATLO1");
        text1.setText(text1.getText()+"\nThe following payment in the college office for the year "+ses1+"-"+ses2);
        text1.setText(text1.getText()+"\n==========================================================================================\n");
        text1.setText(text1.getText()+"Sr. No\t\tHeads\t\tAmount(Rs)");
        text1.setText(text1.getText()+"\n==========================================================================================");
        text1.setText(text1.getText()+"\n1\t\t"+c+"\t\t"+amount);
        text1.setText(text1.getText()+"\n \t\tGST\t\t"+item);
        text1.setText(text1.getText()+"\n \t\tSGST\t\t"+item1);
